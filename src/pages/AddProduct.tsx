  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addProduct({
        ...
        image: formData.image || '', // Will use placeholder in display
      });
      ...
      <Card className="shadow-elevated">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-eco-secondary/50 p-4 rounded-lg">
              <h4 className="font-semibold text-foreground mb-2">Listing Tips</h4>
